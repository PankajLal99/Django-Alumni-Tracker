...
def load():
    ...
    #browser = webdriver.Chrome("/home/pankaj/chromedriver",chrome_options=chrome_options)
    browser = webdriver.Chrome("C:/Users/lalpa/AppData/Local/Google/Chrome/Application/chromedriver.exe",chrome_options=chrome_options)
